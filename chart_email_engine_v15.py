...
if __name__ == "__main__":
    if "--test" in sys.argv:
        ...
        print(f"  Rendering all 14 chart types ({'dark' if dark else 'light'} mode)")
        print("=" * 62)
        ...
        print(f"                      metric_card, table_chart, funnel_altair,")
        print(f"                      bullet_altair, grouped_bar_altair, stacked_bar_altair")
